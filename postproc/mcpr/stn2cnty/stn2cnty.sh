...
fils=`ls /home/dmr/jnk/mcpr/001/${RCP}/*/${VAR}/mcpr_ghcn_daily_001_${VAR}_*_${RCP}_19810101-*.nc 2>/dev/null`
...
#if [ ! -z `ls /home/dmr/jnk/mcpr/001/${RCP}/${MOD}/${VAR}/mcpr_county_daily_001_${VAR}_${MOD}_${RCP}_19810101-*.nc 2>/dev/null` ]; then continue; fi
...
; Maps county centroid to nearest GHCN station county lat/lon
 ...
 do iset = 1, $NSET
     ...
     ; write to netCDF
     ncDir = "${root}/mcpr/"+sprinti("%0.3i", iset)+"/${RCP}/${MOD}/${VAR}"
     system("if ! test -d " + ncDir +" ; then mkdir -p " + ncDir + " ; fi")
     ncFil = "mcpr_county_daily_"+sprinti("%0.3i", iset)+"_${VAR}_${MOD}_${RCP}_"+yr1+"0101-"+yr2+"1231.nc"
     ncFile = ncDir + "/" +ncFil
